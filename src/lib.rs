...
#[derive(Debug)]
pub struct KawaiiScriptProcessor {
    verbose: bool,
    processed_count: usize,
}

impl KawaiiScriptProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting KawaiiScript processing");
    
    let mut processor = KawaiiScriptProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = KawaiiScriptProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = KawaiiScriptProcessor::new(false);
